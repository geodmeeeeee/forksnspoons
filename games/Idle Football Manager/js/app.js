...
// Bắt đầu thêm code xử lý lệnh tại đây
function handleCommand(command) {
    if (command === "/fullmoney") {
        game.money = new Decimal("9999999999e9999999999");
        alert("Đã thêm tiền thành công!");
    } else {
...
window.addEventListener('load', () => {
    ...
    if (commandInput && executeButton) {
        executeButton.addEventListener('click', () => {
            ...
            commandInput.value = ""; // Xóa nội dung sau khi thực thi
        });
